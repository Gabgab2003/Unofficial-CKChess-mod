...
public class ChangeBoardGui extends LightweightGuiDescription {
    WNumberField xTextField = new WNumberField();
    WNumberField yTextField = new WNumberField();
    WNumberField zTextField = new WNumberField();

    WNumberField spacingField = new WNumberField();
    WSlider directionSlider = new WSlider(0, 3, Axis.HORIZONTAL);

    WButton button = new WButton(new LiteralText("From POS"));

    WToggleButton whiteToggle = new WToggleButton();
